    ...
    private void displayAllData() {
        ...
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
                ...
                nasabah.put(Konfigurasi.TAG_JSON_NO_REKENING, no_rekening);
        ...
        ListAdapter adapter = new SimpleAdapter(
                ...
                new String[]{Konfigurasi.TAG_JSON_ID, Konfigurasi.TAG_JSON_NAMA, Konfigurasi.TAG_JSON_NO_REKENING},
                new int[]{R.id.txt_id, R.id.txt_name, R.id.txt_no_rekening}
        );
